package lk.jiat.SkyLand.Login;

import javax.swing.JOptionPane;
import lk.jiat.SkyLand.connection.MySQL;
import java.sql.ResultSet;
import lk.jiat.SkyLand.Employee.EmployeeRegistration;

public class SigninMy extends javax.swing.JFrame {
    ...
    public static void setEmployeeEmail(String employeeEmail) {
        SigninMy.employeeEmail = employeeEmail;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Sign In Process");
        ...
        jLabel8.setText("Don't have eny Account?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (email.isEmpty()) {
            ...
            try {
                ResultSet rs = MySQL.executeSearch("SELECT * FROM `employee` WHERE `email` = '" + email + "' AND `nic` = '" + password + "'");

                if (rs.next()) {

                   int empType = rs.getInt("employee_type_id");
                    String fName = rs.getString("first_name");
                    String lName = rs.getString("last_name");

                    SigninMy.setEmployeeEmail(email);
                    ...
                    if (empType == 1) {
                       ...
                       System.out.println("Welcome Tenant");
                        ...
                        JOptionPane.showMessageDialog(this, "Unknown employee type: " + empType, "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SigninMy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
