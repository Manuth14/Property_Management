...
public class Employee_Salary extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Display_Employees display_Employees = new Display_Employees(dashBoard, true);
        display_Employees.setEmployeeSalary(this);
        display_Employees.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        int option = JOptionPane.showConfirmDialog(this, "Do you want to Change Bonus Type", "Message",
