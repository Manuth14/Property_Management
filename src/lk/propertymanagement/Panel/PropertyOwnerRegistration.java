...
public class PropertyOwnerRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Property Owner Registration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (id.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please give the ID", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "Please enter your city", "Warning", JOptionPane.WARNING_MESSAGE);
               ...
               MySQL.executeIUD("INSERT INTO `property_owner` (`id`,`first_name`,`last_name`,`email`,`mobile`,`nic`,`gender_id`,"
                        + "`status_id`,`line_01`,`line_02`,`city_id`)"
                       + "VALUES('" + id + "','" + firstName + "','" + lastName + "','" + email + "','" + mobile + "','" + nic + "',"
                ...
                PropertyOwnerList p = new PropertyOwnerList();
                p.setVisible(true);
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PropertyOwnerRegistration().setVisible(true);
            }
        });
    }
